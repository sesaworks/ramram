...
class MainMenu extends Phaser.Scene {
    ...
    create() {
        ...
        this.buttonSettings = new ButtonWorks(20, 20, 'button-settings', this.clickSettings, this);
        this.buttonSettings.setOrigin(0, 0);

        var buttonEnclave =  new ButtonWorks(20, EPT.world.height-40, 'logo-enclave', this.clickEnclave, this, 'static');
        buttonEnclave.setOrigin(0, 1);

        this.buttonStart = new ButtonWorks(EPT.world.width-20, EPT.world.height-20, 'button-start', this.clickStart, this);
    ...
    addFiles() {
        var resources = {
            ...
            'audio': [
                ['sound-click', ['sfx/audio-button.mp3','sfx/audio-button.ogg']],
                ['music-theme', ['sfx/mantraloka-bgscore.mp3','sfx/mantraloka-bgscore.ogg']],
                ['sound-pray', ['sfx/pray.mp3','sfx/pray.ogg']]
            ]
        };            
