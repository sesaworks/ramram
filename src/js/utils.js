...
EPT.Sfx = {
	manage: function(type, mode, game, button, label) {
        ...
        if(type == 'sound') {
          ...
          // KCN
          EPT.Sfx.sounds['pray'] = game.sound.add('sound-pray', {volume: 0.25});
        }
        else { // music
...
EPT.Lang = {
  ...
  text: {
    ...
    'pl': {
      ...
      'credits': 'tirupatidasa@sesaworks.com',
      'madeby': 'Sesaworks',
      'team': 'ZESPÓŁ',
      'coding': 'kodowanie',
      'design': 'grafika',
...
script.onload = function() {
  ...
  gtag('js', new Date());
  gtag('config', 'G-ZYYBW3RSCW');
}
script.src = 'https://www.googletagmanager.com/gtag/js?id=G-ZYYBW3RSCW';
