...
class Settings extends Phaser.Scene {
    ...
    create() {
		...
		this.buttonBack = new ButtonWorks(20, 20, 'button-back', this.clickBack, this);
		...
		this.buttonSound = new ButtonWorks(offsetLeft+40, 250, 'button-sound-on', this.clickSound, this);
		...
		this.buttonMusic = new ButtonWorks(offsetLeft+40, 375, 'button-music-on', this.clickMusic, this);
		...
		this.buttonCredits = new ButtonWorks(offsetLeft+40, 500, 'button-credits', this.clickCredits, this);
		...
		*/
		...
		var creditsBack = new ButtonWorks(20, 20, 'button-back', function(){this.clickBack('credits');}, this);
		...
		var titleCreditsLogo = new ButtonWorks(EPT.world.centerX, offsetTopCredits+270, 'logo-enclave', this.clickEnclave, this, 'noframes');
		titleCreditsLogo.setOrigin(0.5,0);
		var titleCreditsUrl = this.add.text(EPT.world.centerX, offsetTopCredits+400, 'instagram.com/tirupatidasa', fontSubtitle);
	...
	clickEnclave() {
		EPT.Sfx.play('click');
		window.top.location.href = 'https://instagram.com/tirupatidasa';
	}
};
